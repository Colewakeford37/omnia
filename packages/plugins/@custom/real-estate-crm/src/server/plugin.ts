/**
 * Real Estate CRM Plugin for NocoBase
 * 
 * This plugin provides a comprehensive Real Estate CRM with:
 * - Lead Management
 * - Contact Management  
 * - Property Listings
 * - Deal/Opportunity Tracking
 * - Enterprise Action Plans with Tasks and Checklists
 * - Cold Calling Features with 20+ Working Principles
 * - AI Integration Support
 * 
 * Author: Custom CRM Development
 * License: Apache-2.0
 */
...
export class RealEstateCRMPlugin extends Plugin {
  async afterAdd() {
  ...
  async load() {
    ...
    // Define all CRM Collections
    await this.defineCollections(db);
  }

  private async defineCollections(db: Database) {
    // ========================================
    ...
    // 4. Deals/Opportunities Collection
    db.collection({
      name: 'crm_deals',
      title: 'Deals',
      sortable: true,
    ...
    // ========================================
    // COLD CALLING & ENGAGEMENT COLLECTIONS
    // ========================================

    // 5. Contact Reasons (20+ Working Principles)
    db.collection({
    ...
    // 7. Scheduled Follow-ups Collection
    db.collection({
      name: 'crm_follow_ups',
      title: 'Follow-ups',
      fields: [
    ...
    // ========================================
    // ENTERPRISE ACTION PLANS & TASKS
    // ========================================

    // 8. Action Plans Collection
    db.collection({
    ...
    // 10. Checklist Templates Collection
    db.collection({
    ...
    // 14. Sectional Title Data Collection
    db.collection({
    ...
    // 16. Activity History Collection
    db.collection({
      name: 'crm_activities',
      title: 'Activities',
      fields: [
  ...
  async install() {
    // Insert default contact reasons (20+ Working Principles)
    const reasons = [
